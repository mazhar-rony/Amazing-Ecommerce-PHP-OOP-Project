                                    ...
                                    <form action="update.php" id="create_slide" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="caption_title" name="caption_title" value="<?= $slide['caption_title'] ?>" required="required" class="form-control ">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <textarea name="caption" id="caption" rows="3" class="form-control"><?= $slide['caption'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="item form-group text-center">
                                            <div class="col-md-4 col-sm-4 offset-2">
                                                <img src="<?= $upload_url . "slides/" . $slide['image'] ?>" height="100" width="100" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="hidden" name="image_existing" value="<?= $slide['image'] ?>">
