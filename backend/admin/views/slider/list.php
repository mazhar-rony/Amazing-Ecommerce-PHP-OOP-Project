                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                ...
                                <td><?= $slide['caption'] ?></td>
                                <td class="text-center"><img src="<?= $upload_url . "slides/" . $slide['image'] ?>" alt="Slide" width="50" height="50"></td>
                                <td><?= $slide['created_at'] ?></td>
                                <td><?= $slide['updated_at'] ?></td>
                                <td class="d-flex">
                                  <a class="btn btn-primary btn-sm" href="show.php?id=<?= $slide['id'] ?>">Show</a> 
                                  <a class="btn btn-warning btn-sm" href="edit.php?id=<?= $slide['id'] ?>">Edit</a> 
