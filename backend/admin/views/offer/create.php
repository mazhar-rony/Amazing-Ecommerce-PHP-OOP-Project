                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form action="store.php" id="create_slide" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="caption_title" name="caption_title" required="required" class="form-control ">
                                            </div>
                                        </div>
                                        <div class="item form-group">
