                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                <td><?= $key + 1 ?></td>
                                <td><?= $offer['caption_title'] ?></td>
                                <td><?= $offer['caption'] ?></td>
                                <td class="text-center"><img src="<?= $upload_url . "offers/" . $offer['image'] ?>" alt="Slide" width="50" height="50"></td>
                                <td><?= $offer['created_at'] ?></td>
                                <td><?= $offer['updated_at'] ?></td>
                                <td class="d-flex">
                                  <a class="btn btn-primary btn-sm" href="show.php?id=<?= $offer['id'] ?>">Show</a> 
                                  <a class="btn btn-warning btn-sm" href="edit.php?id=<?= $offer['id'] ?>">Edit</a> 
