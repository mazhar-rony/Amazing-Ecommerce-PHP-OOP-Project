                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            <img src="<?= $upload_url . "offers/" . $offer['image'] ?>" alt="offer" height="200rem;">
                                            <h5 class="card-title"><?= $offer['caption_title'] ?></h5>
                                            <p class="card-text"><?= $offer['caption'] ?></p>
