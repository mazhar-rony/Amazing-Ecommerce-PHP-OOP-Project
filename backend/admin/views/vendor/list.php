                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                <td><?= $key + 1 ?></td>
                                <td class="text-center"><img src="<?= $upload_url . "vendors/" . $vendor['image'] ?>" alt="Slide" width="50" height="50"></td>
                                <td><?= $vendor['created_at'] ?></td>
                                <td><?= $vendor['updated_at'] ?></td>
                                <td class="d-flex">
                                  <a class="btn btn-primary btn-sm" href="show.php?id=<?= $vendor['id'] ?>">Show</a> 
                                  <a class="btn btn-warning btn-sm" href="edit.php?id=<?= $vendor['id'] ?>">Edit</a> 
