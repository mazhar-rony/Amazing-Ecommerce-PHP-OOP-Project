                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form action="update.php" id="create_product" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="product_name" name="product_name" value="<?= $product['product_name'] ?>" required="required" class="form-control ">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <textarea name="product_info" id="product_info" rows="3" class="form-control"><?= $product['product_info'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="number" id="actual_price" value="<?= $product['actual_price'] ?>" name="actual_price" required="required" class="form-control ">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="number" id="discounted_price" value="<?= $product['discounted_price'] ?>" name="discounted_price" required="required" class="form-control ">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select class="form-control" name="product_category">
                                                    ...
                                                    <?php foreach ($categories as $category) : ?>
                                                        <option value="<?= $category['id'] ?>" <?= $category['id'] === $product['product_category'] ? 'selected' : '' ?>><?= $category['category_name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select class="form-control" name="product_type">
                                                    ...
                                                    <?php foreach ($product_types as $product_type) : ?>
                                                        <option value="<?= $product_type['id'] ?>" <?= $product_type['id'] === $product['product_type'] ? 'selected' : '' ?>><?= $product_type['product_type'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select class="select2_multiple form-control" name="product_color" multiple="multiple">
                                                    ...
                                                    <?php foreach ($product_colors as $product_color) : ?>
                                                        <option value="<?= $product_color['id'] ?>"  <?= $product_color['id'] === $product['product_color'] ? 'selected' : '' ?>><?= $product_color['color_name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select class="select2_multiple form-control" name="product_size" multiple="multiple">
                                                    ...
                                                    <?php foreach ($product_sizes as $product_size) : ?>
                                                        <option value="<?= $product_size['id'] ?>" <?= $product_size['id'] === $product['product_size'] ? 'selected' : '' ?>><?= $product_size['size'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="item form-group text-center">
                                            <div class="col-md-4 col-sm-4 offset-2">
                                                <img src="<?= $upload_url . "products/" . $product['image'] ?>" height="100" width="100" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="hidden" name="image_existing" value="<?= $product['image'] ?>">
