                                ...
                                <div class="x_content">
                                    ...
                                    <div class="card text-center">
                                        <div class="card-header">
                                            Product Type No - <?= $productType['id'] ?>
                                        </div>
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $productType['product_type'] ?></h5>
                                            <a class="btn btn-primary" href="list.php">Go to List</a>
                                        </div>
                                        <div class="card-footer text-muted">
                                            Created At - <?= $productType['created_at'] ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
